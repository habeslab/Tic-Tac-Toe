...
const char aistring_layer_maxpool2d[]="MaxPool2D";

const char aistring_error_maxpool2d_1[]="[ailayer_maxpool2d] Padding shape must be smaller than pool_size.\n";
const char aistring_error_maxpool2d_2[]="[ailayer_maxpool2d] Channel axis must be either 1 (-3) or 3 (-1).\n";

const char aistring_print_layer_specs_maxpool2d_1[]="pool_size: (";
const char aistring_print_layer_specs_maxpool2d_2[]= "); stride: (";
const char aistring_print_layer_specs_maxpool2d_3[]= "); padding: (";
const char aistring_print_layer_specs_maxpool2d_4[]= "); channel_axis: ";
const char aistring_print_layer_specs_maxpool2d_5[]= ", ";

AISTRING_STORAGE_WRAPPER(aistring_layer_maxpool2d);
...
AISTRING_STORAGE_WRAPPER(aistring_error_maxpool2d_1);
AISTRING_STORAGE_WRAPPER(aistring_error_maxpool2d_2);
...
#ifdef AIDEBUG_PRINT_MODULE_SPECS
AISTRING_STORAGE_WRAPPER(aistring_print_layer_specs_maxpool2d_1);
AISTRING_STORAGE_WRAPPER(aistring_print_layer_specs_maxpool2d_2);
AISTRING_STORAGE_WRAPPER(aistring_print_layer_specs_maxpool2d_3);
AISTRING_STORAGE_WRAPPER(aistring_print_layer_specs_maxpool2d_4);
