...
const char aistring_layer_reshape[]="Reshape";
const char aistring_print_layer_specs_reshape1[]="output_shape: [";
const char aistring_print_layer_specs_reshape2[]=",";
const char aistring_print_layer_specs_reshape3[]="]";

AISTRING_STORAGE_WRAPPER(aistring_layer_reshape);
...
#ifdef AIDEBUG_PRINT_MODULE_SPECS
AISTRING_STORAGE_WRAPPER(aistring_print_layer_specs_reshape1);
