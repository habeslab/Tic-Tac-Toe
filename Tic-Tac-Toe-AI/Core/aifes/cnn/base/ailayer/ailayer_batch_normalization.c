...
const char aistring_layer_batch_norm[]= "Batch Normalization";

const char aistring_print_layer_specs_batch_norm_1[]="momentum: ";
const char aistring_print_layer_specs_batch_norm_2[]=", eps: ";
const char aistring_print_layer_specs_batch_norm_3[]=", channel_axis: ";

AISTRING_STORAGE_WRAPPER(aistring_layer_batch_norm);
...
AISTRING_STORAGE_WRAPPER(aistring_print_layer_specs_batch_norm_1);
AISTRING_STORAGE_WRAPPER(aistring_print_layer_specs_batch_norm_2);
AISTRING_STORAGE_WRAPPER(aistring_print_layer_specs_batch_norm_3);
