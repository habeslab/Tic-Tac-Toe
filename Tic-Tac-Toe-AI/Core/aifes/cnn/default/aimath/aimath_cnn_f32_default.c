...
const char aistring_error_f32_conv2d_add_default_1[] = "[aimath_f32_default_conv2d_add] Conv2d output shape doesn't match.\n";
const char aistring_error_f32_maxpool2d_default_1[] = "[aimath_f32_default_maxpool2d] MaxPool2D output shape doesn't match.\n";

const char aistring_error_f32_padding_1[] = "[aimath_f32_default_pad] Output shape doesn't match.\n""[aimath_f32_default_pad] Output shape doesn't match.\n";


AISTRING_STORAGE_WRAPPER(aistring_error_f32_conv2d_add_default_1);
...
AISTRING_STORAGE_WRAPPER(aistring_error_f32_maxpool2d_default_1);
...
AISTRING_STORAGE_WRAPPER(aistring_error_f32_padding_1);
