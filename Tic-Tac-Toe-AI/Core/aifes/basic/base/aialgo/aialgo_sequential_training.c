...
const char aistring_error_no_output_layer[]="[aialgo_..._training_memory] Layer output missing! Define a loss for every output layer or use aialgo_..._inference_memory() instead.\n";

#ifdef AIDEBUG_GENERAL_CHECKS
AISTRING_STORAGE_WRAPPER(aistring_error_no_output_layer);
#endif
...
#ifdef AIDEBUG_GENERAL_CHECKS
const char aistring_error_backward_1[]="[aialgo_backward_model] No backward function implementation in the layer\n";
AISTRING_STORAGE_WRAPPER(aistring_error_backward_1);
#endif
...
const char aistring_error_train_model_1[]="[aialgo_train_model] ERROR: Batch size must be dividable by the input layer batch size.\n";
AISTRING_STORAGE_WRAPPER(aistring_error_train_model_1);
...
const char aistring_error_loss_model_1[]="[aialgo_calc_loss_model] ERROR: Number of samples must be dividable by the input layer batch size.\n";
AISTRING_STORAGE_WRAPPER(aistring_error_loss_model_1);
...
const char aistring_print_loss_specs_1[]=" (";
const char aistring_print_loss_specs_2[]=") <";
const char aistring_print_loss_specs_3[]=">";
...
const char aistring_print_optimizer_specs_1[]=" (";
const char aistring_print_optimizer_specs_2[]=") <";
const char aistring_print_optimizer_specs_3[]=">";
