...
const char aistring_error_inference_model_1[]="[aialgo_inference_model] Error: Number of samples must be dividable by the input layer batch size.\n";

AISTRING_STORAGE_WRAPPER(aistring_error_inference_model_1);
...
const char aistring_error_set_model_delta_precision_q31_1[]="[aialgo_set_model_delta_precision_q31] No loss defined in the model.\n";

AISTRING_STORAGE_WRAPPER(aistring_error_set_model_delta_precision_q31_1);
...
const char aistring_print_model_structure_1[]=": ";

const char aistring_print_model_structure_2[]=" (";
const char aistring_print_model_structure_3[]=") < ";
const char aistring_print_model_structure_4[]=">\n ";
const char aistring_print_model_structure_5[]= ": No specification found for this layer.\n";
