...
const char aistring_layer_leaky_relu[]="Leaky ReLU";

AISTRING_STORAGE_WRAPPER(aistring_layer_leaky_relu);
...
const char aistring_print_layer_specs_leaky_relu_1[]="alpha:";

AISTRING_STORAGE_WRAPPER(aistring_print_layer_specs_leaky_relu_1);
