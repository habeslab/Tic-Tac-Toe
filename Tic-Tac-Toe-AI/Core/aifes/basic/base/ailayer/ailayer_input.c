...
const char aistring_layer_input[]="Input";

AISTRING_STORAGE_WRAPPER(aistring_layer_input);
...
const char aistring_print_layer_specs_input_1[]="Dim: ";
const char aistring_print_layer_specs_input_2[]="; Shape: [";
const char aistring_print_layer_specs_input_3[]=", ";
const char aistring_print_layer_specs_input_4[]=" ]";

AISTRING_STORAGE_WRAPPER(aistring_print_layer_specs_input_1);
