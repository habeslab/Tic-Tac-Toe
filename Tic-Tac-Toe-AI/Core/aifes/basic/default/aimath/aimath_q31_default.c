...
const char aistring_error_q31_linear32_1[]="[aimath_q31_default_linear32] MatMul input shapes doesn't match.\n";
const char aistring_error_q31_linear32_2[]="[aimath_q31_default_linear32] MatMul output shape doesn't match.\n";


const char aistring_error_q31_tensor_sqrt_1[] = "[aimath_q31_default_tensor_sqrt] Sqrt of a negative integer is not supported\n";


AISTRING_STORAGE_WRAPPER(aistring_error_q31_linear32_1);
AISTRING_STORAGE_WRAPPER(aistring_error_q31_linear32_2);
...
AISTRING_STORAGE_WRAPPER(aistring_error_q31_tensor_sqrt_1);
