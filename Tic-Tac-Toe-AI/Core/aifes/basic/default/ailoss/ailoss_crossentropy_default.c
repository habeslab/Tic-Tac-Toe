...
const char aistring_error_loss_crossentropy_f32_1[]= "[ailoss_crossentropy_f32_default] Input layer type not supported\n";
const char aistring_error_loss_crossentropy_sparse8_f32_1[]="[ailoss_crossentropy_f32_default] Input layer type not supported\n";


AISTRING_STORAGE_WRAPPER(aistring_error_loss_crossentropy_f32_1);
...
AISTRING_STORAGE_WRAPPER(aistring_error_loss_crossentropy_sparse8_f32_1);
