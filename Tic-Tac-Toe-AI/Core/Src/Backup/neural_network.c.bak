...
const uint32_t model_parameters[ 335 ] = {
...
void init_ai_agent(UART_HandleTypeDef *huart) {
    ...
    #if __AVR__
    // Only on AVR controllers (e.g. Arduino UNO) with weights in PROGMEM
    ...
    // Only on ARM controllers (e.g. Arduino Nano 33 BLE). AIFES_WITH_CMSIS must be activated in aifes_config.h and CMSIS-NN library must be available in the AIfES_for_Arduino library.
