...
const char aistring_layer_conv2d[] = "Conv2D" ;
const char aistring_error_conv2d_1[] = "[ailayer_conv2d] Channel axis must be either 1 (-3) or 3 (-1).\n";


const char aistring_print_layer_specs_conv2d_1[]="filter_count: ";
const char aistring_print_layer_specs_conv2d_2[]="; kernel_size: (";
const char aistring_print_layer_specs_conv2d_3[]="); stride: (";
const char aistring_print_layer_specs_conv2d_4[]="); dilation: (";
const char aistring_print_layer_specs_conv2d_5[]="); padding: (";
const char aistring_print_layer_specs_conv2d_6[]="); channel_axis: ";
const char aistring_print_layer_specs_conv2d_7[]=", ";


AISTRING_STORAGE_WRAPPER(aistring_layer_conv2d);
...
AISTRING_STORAGE_WRAPPER(aistring_error_conv2d_1);
...
#ifdef AIDEBUG_PRINT_MODULE_SPECS
AISTRING_STORAGE_WRAPPER(aistring_print_layer_specs_conv2d_1);
AISTRING_STORAGE_WRAPPER(aistring_print_layer_specs_conv2d_2);
AISTRING_STORAGE_WRAPPER(aistring_print_layer_specs_conv2d_3);
AISTRING_STORAGE_WRAPPER(aistring_print_layer_specs_conv2d_4);
AISTRING_STORAGE_WRAPPER(aistring_print_layer_specs_conv2d_5);
AISTRING_STORAGE_WRAPPER(aistring_print_layer_specs_conv2d_6);
