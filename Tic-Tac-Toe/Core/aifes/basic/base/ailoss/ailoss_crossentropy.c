...
const char aistring_loss_crossentropy[]="Cross-Entropy";

AISTRING_STORAGE_WRAPPER(aistring_loss_crossentropy);
...
const char aistring_error_loss_crossentropy_1[]="[ailoss_crossentropy] No valid input layer. Use either Sigmoid or Softmax as input.\n";


AISTRING_STORAGE_WRAPPER(aistring_error_loss_crossentropy_1);
