...
const char aistring_dtype_q7[]="Q7";

const char aistring_q7_print_aitensor_bracket[] = " (";
const char aistring_q7_print_aitensor_tab[] = ")\t";
const char aistring_q7_print_aitensor_nl[] = "\n";
const char aistring_q7_print_aitensor_1[] = "Q7 (S: ";
const char aistring_q7_print_aitensor_2[] = "; ZP: ";
const char aistring_q7_print_aitensor_3[] = ") [\n";
const char aistring_q7_print_aitensor_4[] = "]\n";


const char aistring_q7_print_aiscalar_1[]=" (Q7 | V: ";
const char aistring_q7_print_aiscalar_2[]="; S: ";
const char aistring_q7_print_aiscalar_3[]="; ZP: ";
const char aistring_q7_print_aiscalar_4[]=")";

AISTRING_STORAGE_WRAPPER(aistring_dtype_q7);
...
AISTRING_STORAGE_WRAPPER(aistring_q7_print_aitensor_1);
...
AISTRING_STORAGE_WRAPPER(aistring_q7_print_aiscalar_1);
...
char const aistring_error_q7_calc_q_params_from_f32_1[]="[aimath_q7_calc_q_params_from_f32] min_value has to be smaller than max_value.\n";
char const aistring_error_q7_calc_q_params_from_f32_2[]="[aimath_q7_calc_q_params_from_f32] One or more values are too big to quantize them to a 8 bit integer.\n";


AISTRING_STORAGE_WRAPPER(aistring_error_q7_calc_q_params_from_f32_1);
AISTRING_STORAGE_WRAPPER(aistring_error_q7_calc_q_params_from_f32_2);
