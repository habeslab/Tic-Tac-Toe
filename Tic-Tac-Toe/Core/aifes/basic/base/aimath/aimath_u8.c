...
const char aistring_dtype_u8[]="U8";

const char aistring_u8_print_aitensor_tab[]="\t";
const char aistring_u8_print_aitensor_nl[]="\n";
const char aistring_u8_print_aitensor_1[]="U8 [\n";
const char aistring_u8_print_aitensor_2[]="]\n";

const char aistring_u8_print_aiscalar_1[]=" (U8)";

AISTRING_STORAGE_WRAPPER(aistring_dtype_u8);
...
AISTRING_STORAGE_WRAPPER(aistring_u8_print_aitensor_1);
...
AISTRING_STORAGE_WRAPPER(aistring_u8_print_aiscalar_1);
