...
const char aistring_dtype_q31[]="Q31";


const char aistring_q31_print_aitensor_bracket[]=" (";
const char aistring_q31_print_aitensor_tab[]=")\t";
const char aistring_q31_print_aitensor_nl[]="\n";
const char aistring_q31_print_aitensor_1[]="Q31 (S: ";
const char aistring_q31_print_aitensor_2[]="; ZP: ";
const char aistring_q31_print_aitensor_3[]=") [\n";
const char aistring_q31_print_aitensor_4[]="] \n";


const char aistring_q31_print_aiscalar_1[]=" (Q31 | V: ";
const char aistring_q31_print_aiscalar_2[]= "; S: ";
const char aistring_q31_print_aiscalar_3[]="; ZP:";
const char aistring_q31_print_aiscalar_4[]=" )";

AISTRING_STORAGE_WRAPPER(aistring_dtype_q31);
...
AISTRING_STORAGE_WRAPPER(aistring_q31_print_aitensor_1);
...
AISTRING_STORAGE_WRAPPER(aistring_q31_print_aiscalar_1);
