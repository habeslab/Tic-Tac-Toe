...
const char aistring_dtype_f32[]="F32";

const char aistring_f32_print_aitensor_tab[]="\t";
const char aistring_f32_print_aitensor_nl[]="\n";
const char aistring_f32_print_aitensor_1[]="F32 [";
const char aistring_f32_print_aitensor_2[]="]\n";

const char  aistring_f32_print_aiscalar_1[] = " (F32)";

AISTRING_STORAGE_WRAPPER(aistring_dtype_f32);
...
AISTRING_STORAGE_WRAPPER(aistring_f32_print_aitensor_1);
...
AISTRING_STORAGE_WRAPPER(aistring_f32_print_aiscalar_1);
