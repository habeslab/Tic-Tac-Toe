...
const char aistring_opti_sgd[]="SGS";

const char aistring_opti_sgd_print_specs_1[]="lr: ";
const char aistring_opti_sgd_print_specs_2[]="; momentum: ";

AISTRING_STORAGE_WRAPPER(aistring_opti_sgd);
...
AISTRING_STORAGE_WRAPPER(aistring_opti_sgd_print_specs_1);
AISTRING_STORAGE_WRAPPER(aistring_opti_sgd_print_specs_2);
