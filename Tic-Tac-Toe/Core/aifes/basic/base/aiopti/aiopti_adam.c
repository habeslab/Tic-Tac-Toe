...
const char aistring_opti_adam[]= "Adam";

const char aistring_opti_adam_print_specs_1[] ="lr: ";
const char aistring_opti_adam_print_specs_2[] ="; beta1: ";
const char aistring_opti_adam_print_specs_3[] ="; beta2: " ;
const char aistring_opti_adam_print_specs_4[] =" ; eps: " ;

AISTRING_STORAGE_WRAPPER(aistring_opti_adam);
...
#ifdef AIDEBUG_PRINT_MODULE_SPECS
AISTRING_STORAGE_WRAPPER(aistring_opti_adam_print_specs_1);
AISTRING_STORAGE_WRAPPER(aistring_opti_adam_print_specs_2);
AISTRING_STORAGE_WRAPPER(aistring_opti_adam_print_specs_3);
AISTRING_STORAGE_WRAPPER(aistring_opti_adam_print_specs_4);
