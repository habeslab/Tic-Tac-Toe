...
const char aistring_layer_elu[]="ELU";

AISTRING_STORAGE_WRAPPER(aistring_layer_elu);
...
#ifdef AIDEBUG_PRINT_MODULE_SPECS
const char aistring_print_layer_specs_elu_1[]="alpha: ";

AISTRING_STORAGE_WRAPPER(aistring_print_layer_specs_elu_1);
