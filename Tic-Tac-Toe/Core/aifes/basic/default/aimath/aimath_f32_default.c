...
const char aistring_error_f32_linear_1[]="[aimath_f32_default_linear] MatMul input shapes doesn't match.\n";
const char aistring_error_f32_linear_2[]="[aimath_f32_default_linear] MatMul output shape doesn't match.\n";


AISTRING_STORAGE_WRAPPER(aistring_error_f32_linear_1);
AISTRING_STORAGE_WRAPPER(aistring_error_f32_linear_2);
