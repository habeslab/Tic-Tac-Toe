...
const char aistring_error_q7_linear32_1[] = "[aimath_q7_default_linear32] MatMul input shapes doesn't match.\n";
const char aistring_error_q7_linear32_2[] = "[aimath_q7_default_linear32] MatMul output shape doesn't match.\n";
const char aistring_error_q7_linear32_3[] = "[aimath_q7_default_linear32] Third operand shift does not match.\n";


AISTRING_STORAGE_WRAPPER(aistring_error_q7_linear32_1);
AISTRING_STORAGE_WRAPPER(aistring_error_q7_linear32_2);
AISTRING_STORAGE_WRAPPER(aistring_error_q7_linear32_3);
